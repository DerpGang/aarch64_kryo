/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/home/jenkins/workspace/QTC-Arm/7.3_kryo/.build/aarch64-QUVNTNM_TOOLCHAIN-linux-musl/src/gcc/gcc/config/aarch64/aarch64.md'.  */
